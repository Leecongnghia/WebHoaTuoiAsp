<%@ Page Title="" Language="C#" MasterPageFile="~/HoaTuoiSize.Master" AutoEventWireup="true" CodeBehind="ThemHoa.aspx.cs" Inherits="WebHoaTuoi.ThemHoa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Noidung" runat="server">
    ...
    <div class="row mb-2">
        ...
        <asp:SqlDataSource ID="sdsThemHoa" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HoaTuoiASPConnectionString %>" SelectCommand="SELECT * FROM [Loai]"></asp:SqlDataSource>
